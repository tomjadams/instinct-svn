...
public final class AfterSpecificationNamingConventionAtomicTest extends InstinctTestCase {
    @Subject(implementation = AfterSpecificationNamingConvention.class) private NamingConvention namingConvention;
    ...
    public void testGetPattern() {
        expect.that(namingConvention.getPattern()).equalTo("^tearDown|^after");
    }
}
