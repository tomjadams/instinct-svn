...
public final class ADummyAutoWireDeterminatorWithANamedFieldToAutoWire {
    ...
    public void respondsWithTrue() {
        expect.that(autoWireDeterminator.autoWire(field("dummyCharSequence"))).isTrue();
    }
    ...
    private static final class WithFieldsToAutoWire {
        CharSequence dummyCharSequence;
    }
}
