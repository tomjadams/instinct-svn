...
public final class AMockAutoWireDeterminatorWithANamedFieldNotToAutoWire {
    ...
    public void respondsWithTrue() {
        expect.that(autoWireDeterminator.autoWire(field("mockCharSequence"))).isFalse();
    }
    ...
    private static final class WithNamedFieldsNotToAutoWire {
        @Mock(auto = false) CharSequence mockCharSequence;
    }
}