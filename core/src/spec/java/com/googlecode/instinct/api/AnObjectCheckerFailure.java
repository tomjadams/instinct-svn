...
public class AnObjectCheckerFailure {
    ...
    public void shouldReturnAReadableErrorForTypeChecking() {
        ...
        expectErrorMessage(new ErrorCommand() {public void execute() {integerObjectChecker.isNotTheSameInstanceAs(1);}}, "not same(<1>)","<1>");

        final Person p1 = new Person("Daffy", 3.4);
        final ObjectCheckerImpl<Person> personObjectChecker = new ObjectCheckerImpl<Person>(p1);
        expectErrorMessage(new ErrorCommand() {public void execute() {
            personObjectChecker.isNotTheSameInstanceAs(p1);}}, "not same(<Person[ name=Daffy, height=3.4 ]>)", "<Person[ name=Daffy, height=3.4 ]>");
    }
    ...
    public void shouldReturnAReadableErrorForProperties() {
        ...
        expectErrorMessage(new ErrorCommand() {public void execute() {personObjectChecker.hasBeanProperty("surname", String.class);}},
        ...
        expectErrorMessage(new ErrorCommand() {public void execute() {personObjectChecker.hasBeanProperty("married", boolean.class);}},
        ...
        expectErrorMessage(new ErrorCommand() {public void execute() {personObjectChecker.hasBeanProperty("age", int.class);}},
                "Person.getAge() and/or Person.setAge(int) should exist.",
                "Person.getAge() and/or Person.setAge(int) does not exist.");
    ...
    public void shouldReturnAReadableErrorForPropertiesWithAValue() {
        ...
        final ObjectCheckerImpl<Person> personObjectChecker = new ObjectCheckerImpl<Person>(peepz);
        expectErrorMessage(new ErrorCommand() {public void execute() {personObjectChecker.hasBeanPropertyWithValue("name", String.class,
                equalTo("Pedro"));}},
        ...
        expectErrorMessage(new ErrorCommand() {public void execute() {personObjectChecker.hasBeanPropertyWithValue("height", double.class,
                equalTo(6.1));}},
