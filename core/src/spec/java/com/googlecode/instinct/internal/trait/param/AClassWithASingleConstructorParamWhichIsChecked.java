 ...
 */
public final class AClassWithASingleConstructorParamWhichIsChecked {
    public AClassWithASingleConstructorParamWhichIsChecked(final String str) {
        ParamChecker.checkNotNull(str);
        ParamChecker.checkNotWhitespace(str);
    }
