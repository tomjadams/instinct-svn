...
public final class SpikedSpecificationMethodImpl implements SpikedSpecificationMethod {
    ...
    public SpikedSpecificationMethodImpl(final SpecificationContext specificationContext) {
    ...
    public SpecificationResult run(final SpikedSpecificationListener specificationListener) {
