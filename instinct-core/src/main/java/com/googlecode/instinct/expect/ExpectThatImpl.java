...
import com.googlecode.instinct.expect.state.ArrayCheckerImpl;
import com.googlecode.instinct.expect.state.ClassChecker;
import com.googlecode.instinct.expect.state.ClassCheckerImpl;
import com.googlecode.instinct.expect.state.CollectionChecker;
import com.googlecode.instinct.expect.state.CollectionCheckerImpl;
import com.googlecode.instinct.expect.state.ComparableChecker;
import com.googlecode.instinct.expect.state.ComparableCheckerImpl;
import com.googlecode.instinct.expect.state.DoubleChecker;
import com.googlecode.instinct.expect.state.DoubleCheckerImpl;
import com.googlecode.instinct.expect.state.EventObjectChecker;
import com.googlecode.instinct.expect.state.EventObjectCheckerImpl;
import com.googlecode.instinct.expect.state.IterableChecker;
import com.googlecode.instinct.expect.state.IterableCheckerImpl;
import com.googlecode.instinct.expect.state.MapChecker;
import com.googlecode.instinct.expect.state.MapCheckerImpl;
import com.googlecode.instinct.expect.state.NodeChecker;
import com.googlecode.instinct.expect.state.ObjectCheckerImpl;
import com.googlecode.instinct.expect.state.NodeCheckerImpl;
import com.googlecode.instinct.expect.state.ObjectChecker;
import com.googlecode.instinct.expect.state.StringChecker;
import com.googlecode.instinct.expect.state.StringCheckerImpl;
